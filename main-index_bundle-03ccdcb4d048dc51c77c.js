...
var _section1Bg = __webpack_require__(23);
...
var LoadableHomePage = (0, _reactLoadable2.default)({
  loader: function loader() {
    return __webpack_require__.e(/* import() */ 3).then(__webpack_require__.t.bind(null, 39, 7));
  },
...
var LoadableInitiativePage = (0, _reactLoadable2.default)({
  loader: function loader() {
    return __webpack_require__.e(/* import() */ 7).then(__webpack_require__.t.bind(null, 40, 7));
  },
  render: function render(loaded, props) {
    var Component = loaded.default;
    return _react2.default.createElement(Component, props);
...
var LoadableGalleryPage = (0, _reactLoadable2.default)({
  loader: function loader() {
    return __webpack_require__.e(/* import() */ 6).then(__webpack_require__.t.bind(null, 41, 7));
  },
  render: function render(loaded, props) {
    var Component = loaded.default;
    return _react2.default.createElement(Component, props);
...
var LoadableContactPage = (0, _reactLoadable2.default)({
  loader: function loader() {
    return Promise.all(/* import() */[__webpack_require__.e(4), __webpack_require__.e(5)]).then(__webpack_require__.t.bind(null, 42, 7));
  },
  render: function render(loaded, props) {
    var Component = loaded.default;
    return _react2.default.createElement(Component, props);
    ...
    function Header(props) {
        ...
        _this.render = function () {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'hamburger-menu', onClick: _this.toggleMenu },
                ...
                _react2.default.createElement(
                    'div',
                    { id: 'menu', className: 'menu', onBlur: _this.toggleMenu },
                    _react2.default.createElement(
                        'div',
                        { className: 'close', onClick: _this.toggleMenu },
                        _react2.default.createElement('div', { className: 'tile tile1' }),
                        _react2.default.createElement('div', { className: 'tile tile2' })
                    ),
                    _react2.default.createElement(
                        _reactRouterDom.Link,
                        { onClick: _this.toggleMenu, to: '/' },
                        'Home'
                    ),
                    _react2.default.createElement(
                        _reactRouterDom.Link,
                        { onClick: _this.toggleMenu, className: '' + (location.pathname.includes('initiative') ? 'active' : ''), to: '/initiative' },
                        'Our Initiative'
                    ),
                    _react2.default.createElement(
                        _reactRouterDom.Link,
                        { onClick: _this.toggleMenu, className: '' + (location.pathname.includes('gallery') ? 'active' : ''), to: '/gallery' },
                        'Gallery'
                    ),
                    _react2.default.createElement(
                        _reactRouterDom.Link,
                        { onClick: _this.toggleMenu, className: '' + (location.pathname.includes('contact') ? 'active' : ''), to: '/contact' },
                        'Contact Us'
                    )
                )
            );
...
module.exports = __webpack_require__.p + "src/app/assets/images/Gallery-84a8ac16baf994a363bb3d7a7edc5b72.png";

/***/ }),
/* 36 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "src/app/assets/images/OurInitiative-cd1057532403524af3eea5ea78639c78.png";

/***/ }),
/* 37 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "src/app/assets/images/Contact-us-263ddcde6c53cc61711e6198dd5d56d0.png";
